// Code generated by "stringer -type opcode,closecode,activitytype -output consts_generated.go"; DO NOT EDIT.
...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[activitytypeGame-0]
	_ = x[activitytypeStreaming-1]
	_ = x[activitytypeListening-2]
	_ = x[activitytypeCustom-4]
}

const (
	_activitytype_name_0 = "activitytypeGameactivitytypeStreamingactivitytypeListening"
	_activitytype_name_1 = "activitytypeCustom"
)

var (
	_activitytype_index_0 = [...]uint8{0, 16, 37, 58}
)
